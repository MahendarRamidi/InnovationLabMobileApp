...
extern void *mono_aot_module_InnovationLabMobileApp_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_InnovationLabMobileApp_info;
...
{
	mono_aot_register_module (mono_aot_module_InnovationLabMobileApp_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_InnovationLabMobileApp_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "InnovationLabMobileApp.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
